'''
This datageneratormust be defined before training the network. Custom Keras datagenerators are elaborately described and illustrated here, https://towardsdatascience.com/implementing-custom-data-generators-in-keras-de56f013581c
...
class ValidationGenerator(Sequence):
    ...
    def on_epoch_end(self):
        ...
        raise TypeError('ValidationGenerator is not yet fully implimented!') 
